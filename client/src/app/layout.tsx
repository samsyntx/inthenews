...
export const defaultMetadata: CustomMetadata = {
  ...
  description: "Stay updated with the latest and trending topics in the US. Discover in-depth Tech, Medical, Anime, Projects information and brief introductions on current events.",
  ...
  twitter: {
    ...
    title: "INTHENEWS - In depth fact-checking and Explanatory content",
    description: "Stay updated with the latest and trending topics in the US. Discover in-depth Tech, Medical, Anime, Projects information and brief introductions on current events.",
    image: "https://res.cloudinary.com/dtalgesli/image/upload/v1727439702/inthenews/ITN_hjlyil.png",
  },
};
  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta charSet="UTF-8" />
        <link rel="icon" href="https://res.cloudinary.com/dtalgesli/image/upload/v1727439702/inthenews/ITN_hjlyil.png" type="image/png" />
